      ...
      fashion: [
        {
          ...
          name: "Linen shirt",
          detail: "Olive",
          amount: { NGN: 1200, GHS: 12, KES: 160 },
        },
        {
          id: "canvas-tote",
          name: "Canvas tote",
          detail: "Sand",
          amount: { NGN: 900, GHS: 9, KES: 120 },
        },
        {
          id: "classic-cap",
          name: "Classic cap",
          detail: "Forest",
          amount: { NGN: 600, GHS: 6, KES: 80 },
        },
      ],
      home: [
        {
          ...
          name: "Desk lamp",
          detail: "Warm light",
          amount: { NGN: 1500, GHS: 15, KES: 200 },
        },
        {
          id: "ceramic-cup",
          name: "Ceramic cup",
          detail: "Ivory",
          amount: { NGN: 700, GHS: 7, KES: 95 },
        },
        {
          id: "linen-throw",
          name: "Linen throw",
          detail: "Moss",
          amount: { NGN: 1300, GHS: 13, KES: 175 },
        },
      ],
      food: [
        {
          ...
          name: "Lunch box",
          detail: "Rice bowl",
          amount: { NGN: 800, GHS: 8, KES: 105 },
        },
        {
          id: "coffee-pack",
          name: "Coffee pack",
          detail: "Ground",
          amount: { NGN: 1000, GHS: 10, KES: 135 },
        },
        {
          id: "fruit-box",
          name: "Fruit box",
          detail: "Seasonal",
          amount: { NGN: 1100, GHS: 11, KES: 145 },
        },
      ],
    },
  },
      ...
      services: [
        {
          ...
          amount: { NGN: 1600, GHS: 16, KES: 215 },
        },
        {
          id: "product-shoot",
          name: "Product shoot",
          detail: "Seller: Frame Lab",
          amount: { NGN: 2200, GHS: 22, KES: 295 },
        },
        {
          id: "landing-copy",
          name: "Landing copy",
          detail: "Seller: Ada Writes",
          amount: { NGN: 1400, GHS: 14, KES: 185 },
        },
      ],
      delivery: [
        {
    ...
    items: {
      plans: [
        ...
        },
        {
          ...
          name: "Scale plan",
          detail: "Monthly",
          amount: { NGN: 2400, GHS: 24, KES: 320 },
        },
      ],
      seats: [
        {
        ...
        },
        {
          ...
          name: "10 seats",
          detail: "Monthly",
          amount: { NGN: 1700, GHS: 17, KES: 225 },
        },
        {
          id: "twenty-seats",
          name: "20 seats",
          detail: "Monthly",
          amount: { NGN: 2500, GHS: 25, KES: 335 },
        },
      ],
      usage: [
        {
    ...
    items: {
      ...
      savings: [
        ...
        },
        {
          ...
          amount: { NGN: 1800, GHS: 18, KES: 240 },
        },
        {
          id: "vault-deposit",
          name: "Vault deposit",
      ...
      credit: [
        ...
        },
        {
          ...
          name: "Loan repayment",
          detail: "Early payoff",
          amount: { NGN: 2600, GHS: 26, KES: 345 },
        },
      ],
    },
  },
